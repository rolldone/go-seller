...
type OrderItem struct {
	...
	// ProductType is snapshotted from the catalog at order time.
	// Values: product | service | digital. Used to exclude digital items from shipment.
	ProductType string    `gorm:"size:24;not null;default:'product'" json:"product_type"`
