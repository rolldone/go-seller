...
func (p *Plugin) RegisterRoutes(router *gin.Engine, admin *gin.RouterGroup, api *gin.RouterGroup) error {
	...
	memberCatalogGroup.Use(authhandlers.RequireMemberJWT())
	memberCatalogGroup.GET("/attribute-groups", variationHandler.MemberListAttributeGroups)
	memberCatalogGroup.POST("/attribute-groups", variationHandler.MemberCreateAttributeGroup)
	memberCatalogGroup.GET("/attribute-groups/:id/attributes", variationHandler.MemberListAttributesByGroup)
	memberCatalogGroup.GET("/attribute-groups/:id", variationHandler.MemberGetAttributeGroup)
	memberCatalogGroup.PUT("/attribute-groups/:id", variationHandler.MemberUpdateAttributeGroup)
	memberCatalogGroup.DELETE("/attribute-groups/:id", variationHandler.MemberDeleteAttributeGroup)
	memberCatalogGroup.GET("/attributes/:id", variationHandler.MemberGetAttribute)
	memberCatalogGroup.POST("/attributes", variationHandler.MemberCreateAttribute)
	memberCatalogGroup.PUT("/attributes/:id", variationHandler.MemberUpdateAttribute)
	memberCatalogGroup.DELETE("/attributes/:id", variationHandler.MemberDeleteAttribute)
	memberCatalogGroup.GET("/variations/by-attributes", variationHandler.MemberGetVariationByAttributes)
	memberCatalogGroup.POST("/variations", variationHandler.MemberCreateProductVariation)
	memberCatalogGroup.GET("/variations", variationHandler.MemberListProductVariations)
	memberCatalogGroup.GET("/variations/:id", variationHandler.MemberGetProductVariation)
	memberCatalogGroup.PUT("/variations/:id", variationHandler.MemberUpdateProductVariation)
	memberCatalogGroup.PUT("/variations/:id/assets", variationHandler.MemberUpdateVariationAssets)
	memberCatalogGroup.DELETE("/variations/:id", variationHandler.MemberDeleteProductVariation)
