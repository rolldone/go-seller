...
func main() {
	...
	err := app.Run(app.Options{
		RegisterPlugins: func() {
			...
			plugins.RegisterPlugins([]plugins.Plugin{authplugin.New(), catalogplugin.New(), datasearchplugin.New(), marketingplugin.New(), orderplugin.New(), reviewplugin.New(), settingplugin.New(), notificationplugin.New()})
		},
	})
	if err != nil {
