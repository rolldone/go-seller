...
import { listMemberProducts } from "../products/api";
import type { BusinessOption, Product } from "../products/types";
...
export default function ProductSelectorModal({ open, businessID, businessNameByID, currentProductID, onClose, onSelect }: Props) {
	...
	return (
		<MemberModal open={open} onClose={onClose} title="Select Product" maxWidth="2xl">
			<div className="space-y-4">
				<div className="grid gap-2 md:grid-cols-[2fr,1fr,160px]">
					...
					/>
					<select value={businessFilter} onChange={(e) => setBusinessFilter(e.target.value)} className="rounded border border-slate-300 px-3 py-2 text-sm">
