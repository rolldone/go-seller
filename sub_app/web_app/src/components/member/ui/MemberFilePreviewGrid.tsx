import type { MemberUploadFile } from "./MemberFileUploadDropzone";

type Props = {
  files: MemberUploadFile[];
  onRemove: (id: string) => void;
  onSetMain?: (id: string) => void;
  onReorder?: (files: MemberUploadFile[]) => void;
  onEditFile?: (file: MemberUploadFile) => void;
  editLabel?: string;
};
...
export default function MemberFilePreviewGrid({ files, onRemove, onSetMain, onEditFile, editLabel = "Edit" }: Props) {
  if (files.length === 0) {
    return null;
  }
